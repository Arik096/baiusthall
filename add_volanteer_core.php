...
if(isset($_REQUEST['post_btn']))
{
 try
 {
  ...
  if(!isset($errorMsg))
  {
   $insert_stmt=$db->prepare('INSERT INTO tbl_hr(name,position,description,phn_num,pic) VALUES(:name,:position,:description,:phn_num,:pic)'); //sql insert query
   ...
   if($insert_stmt->execute())
   {
    ...
    header("location: volanteers.php"); //refresh 3 second and redirect to index.php page
   }
  }
 }
